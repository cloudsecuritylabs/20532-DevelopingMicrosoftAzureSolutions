...
1. In the **Create a virtual machine** blade that displays, perform the following steps:
	...
	a. Search for **Visual Studio 2017** and the select the **Visual Studio Community 2017 (latest release) on Windows Server 2016 (x64)** option in the list of results. 
